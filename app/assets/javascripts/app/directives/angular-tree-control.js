		...
		.directive( 'treecontrol', ['$compile', function( $compile ) {
			...
			return {
				...
				controller: ['$scope', function( $scope ) {
					...
					$scope.iBranchClassFont = function() {
						if ($scope.expandedNodesMap[this.$id])
							return classIfDefined($scope.options.injectClasses.iExpanded);
						else
							return classIfDefined($scope.options.injectClasses.iCollapsed);
					...
					var template =
						'<ul '+classIfDefined($scope.options.injectClasses.ul, true)+'>' +
							...
							'<div class="tree-label '+classIfDefined($scope.options.injectClasses.label, false)+'" ng-class="selectedClass()" ng-class="iBranchClassFont()" ng-click="selectNodeLabel(node)" tree-transclude></div>' +
							'<div class="tree-icon"><i class="tree-branch-head glyphicon" ng-class="iBranchClass()" ng-click="selectNodeHead(node)"></i>' +
							'</div>' +
